...
#define MYSQL_PASSWD "262885"
#define MYSQL_DB "db_order_sys"

namespace _order_sys{
extern void MysqlDestory(MYSQL *mysql);
...
#define ORDER_INSERT "insert into tb_orders(id, table_id, dishes, statys, uptime) values(null, %d, '%s', %d, now());"
char buf[4096] = {0};
